...
public class Form_Admin extends javax.swing.JFrame {
    ...
    protected void datatable(){
        Object[] Baris = {"ID User","Username","Password","Level","Jenis Kelamin","Alamat"};
        tabmode = new DefaultTableModel(null, Baris);
        String cariitem = txt_cari.getText();
        try {
            String sql = "SELECT * FROM admin where id like '%"+cariitem+"%' or username like '%"+cariitem+"%' order by id asc";
    ...
    private void initComponents() {
        ...
        jLabel8.setText("List Data Admin ");
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        try {
            ...
            stat.setString(2, txt_uname.getText());
            stat.setString(3, txt_pw.getText());
            stat.setString(4, txt_level.getText());
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        ...
        String sql = "UPDATE admin SET id=?,username=?,password=?,level=?, jenis_kelamin=?, alamat=? WHERE id='"+txt_id.getText()+"'";
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, txt_id.getText());
            stat.setString(2, txt_uname.getText());
